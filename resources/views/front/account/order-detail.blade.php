                            ...
                            <div class="card-body bg-light mb-3">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-lg-3">
                                        ...
                                        <!-- Text -->
                                        <p class="mb-0 fs-sm fw-bold">
                                            Rs.{{number_format($order->final_total,2)}}
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <li class="list-group-item">
                                    <div class="row align-items-center">
                                        <div class="col-4 col-md-3 col-xl-2">
                                            <!-- Image -->
                                            {{-- <a href="product.html"><img src="{{asset('front-assets/images/product-1.jpg')}}" alt="..." class="img-fluid"></a> --}}
                                            @php
                    ...
                    <div class="card-body">
                        ...
                        <ul>
                            <li class="list-group-item d-flex">
                                <span>Subtotal</span>
                                <span class="ms-auto"> Rs.{{number_format($order->final_total,2)}}</span>
                            </li>
                            <li class="list-group-item d-flex">
                                <span>Discount</span>
