                            ...
                            <div class="row">
                               ...
                               <p></p>
                                ...
                                <div class="mb-3">                                    
                                    ...
                                    <select class="form-control" name="country_id" id="country_id"  placeholder="Enter Your Address">
                                ...
                                <div class="mb-3">                                    
                                    ...
                                    <textarea value="{{ (!empty($address) ) ? $address->address : ''}}"  name="address" id="address" class="form-control" cols="30" rows="5" placeholder="Enter Your Address">{{ isset($address->address) ? $address->address : '' }}
                                    </textarea>
                                <p></p>
                                </div>
                                <div class="mb-3 col-md-6">                                    
                                    <label for="house">House no.</label>
                                    <input value="{{ (!empty($address) ) ? $address->house_no : ''}}"   type="text" name="house_no" id="house_no" placeholder="Enter Your house No." class="form-control">
                                    <p></p>
                                </div>
                                <div class="mb-3 col-md-6">                                    
                                ...
                                <div class="mb-3 col-md-6">                                    
                                    ...
                                    <input value="{{ (!empty($address) ) ? $address->district : ''}}"  type="text" name="district" id="district" placeholder="Enter Your Distict" class="form-control">
                                    <p></p>
                                </div>
                                <div class="mb-3 col-md-6">                                    
...
if(response.status == true){
    ...
    $("#house_no").removeClass('is-invalid').siblings('p').html('').removeClass('invalid-feedback');
    $("#district").removeClass('is-invalid').siblings('p').html('').removeClass('invalid-feedback');
...
if(errors.district){
    $("#district").addClass('is-invalid').siblings('p').html(errors.district).addClass('invalid-feedback');
}else{
    $("#district").removeClass('is-invalid').siblings('p').html('').removeClass('invalid-feedback');
}
if(errors.house_no){
    $("#house_no").addClass('is-invalid').siblings('p').html(errors.house_no).addClass('invalid-feedback');
}else{
    $("#house_no").removeClass('is-invalid').siblings('p').html('').removeClass('invalid-feedback');
}
if(errors.zip){
